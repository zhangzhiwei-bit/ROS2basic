...
class Nav_Goal(metaclass=Metaclass_Nav_Goal):
    ...
    def goal_x(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'goal_x' field must be a float in [-3.402823e+38, 3.402823e+38]"
        self._goal_x = value
    ...
    def goal_y(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'goal_y' field must be a float in [-3.402823e+38, 3.402823e+38]"
        self._goal_y = value
    ...
    def goal_theta(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'goal_theta' field must be a float in [-3.402823e+38, 3.402823e+38]"
...
class Nav_Result(metaclass=Metaclass_Nav_Result):
    ...
    def turtle_x(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'turtle_x' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def turtle_y(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'turtle_y' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def turtle_theta(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'turtle_theta' field must be a float in [-3.402823e+38, 3.402823e+38]"
